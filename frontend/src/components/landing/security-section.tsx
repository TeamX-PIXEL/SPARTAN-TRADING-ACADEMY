...
const securityFeatures = [
  {
    ...
    description: "Indicator access lists with automatic expiry management.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Encrypted payments",
    description: "All transactions secured with bank-level encryption.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Purchase audit trails",
    description: "Every purchase and access grant is logged and trackable.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Member permissions",
    description: "Access only what you purchased. No unauthorized sharing.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["PCI DSS", "SSL Secure", "Verified", "Trusted"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Protected,
            <br />
            <span className="text-muted-foreground">always secure.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your purchases and access are protected. Secure payments, controlled indicator access, and full transparency on what you own.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Secure purchase delivery</span>
              </div>
            </div>
